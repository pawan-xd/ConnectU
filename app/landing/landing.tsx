			...
			<div className="container px-5 py-24 mx-auto">
				<div className="flex flex-col text-center w-full mb-20">
					...
					<p className="lg:w-2/3 mx-auto leading-relaxed text-base">
						...
						ConnectU, where organizing and executing unforgettable
						events becomes effortless. Streamline your planning
						process and create extraordinary experiences with our
						intuitive platform.
					</p>
				</div>
